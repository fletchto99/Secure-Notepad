 ...
 * a Java program. Any <tt>java.awt.Component</tt> can be dropped onto, but only <tt>javax.swing.JComponent</tt>s will indicate the drop event with a
 * changed
 * border.
 * <p/>
...
public class FileDrop {
     ...
     * files are dropped onto a registered drop
     * target.
     *
     * <p>
     * I'm releasing this code into the Public Domain. Enjoy.
     ...
     * <tt>net.iharder.dnd.TransferableObject.class</tt> and MIME type <tt>application/x-net.iharder.dnd.TransferableObject</tt>. This data
     ...
     * or <tt>System.err</tt>. A <tt>null</tt> value for the
     ...
     * on. With Debugging turned on, more status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with
     ...
     * With Debugging turned on, more status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with
     * <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the
     * parameter <tt>out</tt> will result in no debugging output.
     *
     * @param out
