...
/**
 * This class makes it easy to drag and drop files from the operating system to a Java program. Any <tt>java.awt.Component</tt> can be dropped onto,
 * but only <tt>javax.swing.JComponent</tt>s will indicate the drop event with a changed border.
 * <p/>
 * To use this class, construct a new <tt>FileDrop</tt> by passing it the target component and a <tt>Listener</tt> to receive notification when
 ...
 * <p/>
 * You can turn on some debugging features by passing a <tt>PrintStream</tt> object (such as <tt>System.out</tt>) into the full constructor. A
 * <tt>null</tt> value will result in no extra debugging information being output.
 * <p/>
 *
 * <p>
...
public class FileDrop {
    /**
     * This is the event that is passed to the {@link FileDropListener#filesDropped filesDropped(...)} method in your {@link FileDropListener} when
     * files are dropped onto a registered drop target.
     *
     * <p>
     * I'm releasing this code into the Public Domain. Enjoy.
     * </p>
    ...
    public static class Event extends java.util.EventObject {
		 ...
		 *
		 */
        private static final long serialVersionUID = 785383107427222683L;
     ...
     * <tt>net.iharder.dnd.TransferableObject.class</tt> and MIME type <tt>application/x-net.iharder.dnd.TransferableObject</tt>. This data flavor is
    ...
    public static class TransferableObject implements Transferable {
        /**
         * Instead of passing your data directly to the {@link TransferableObject} constructor, you may want to know exactly when your data was
         * received in case you need to remove it from its source (or do anyting else to it). When the {@link #getTransferData getTransferData(...)}
         * method is called on the {@link TransferableObject}, the {@link Fetcher}'s {@link #getObject getObject()} method will be called.
         *
         * @author Robert Harder
         * @copyright 2001
         * @version 1.1
         ...
         * @since 1.1
         */
        public TransferableObject(final Class<?> dataClass,
        ...
        /**
         * Creates a new {@link TransferableObject} that will return the object that is returned by <var>fetcher</var>. No custom data flavor is set
         ...
         * creates a custom data flavor with a representation class determined from <code>data.getClass()</code> and the MIME type
        ...
        public TransferableObject(final Object data) {
            this.data = data;
            customFlavor = new java.awt.datatransfer.DataFlavor(
                    data.getClass(), TransferableObject.MIME_TYPE);
        } // end constructor

        /* ******** T R A N S F E R A B L E M E T H O D S ******** */

        /**
         * Returns the custom {@link java.awt.datatransfer.DataFlavor} associated with the encapsulated object or <tt>null</tt> if the {@link Fetcher}
         ...
         * {@link #DATA_FLAVOR} associated with {@link TransferableObject}, and third the {@link java.awt.datatransfer.DataFlavor.stringFlavor}.
         *
        ...
        /**
         * Returns <tt>true</tt> if <var>flavor</var> is one of the supported flavors. Flavors are supported using the <code>equals(...)</code>
         * method.
         *
         * @param flavor
    ...
    public static boolean remove(final java.io.PrintStream out,
            final java.awt.Component c, final boolean recursive) { // Make sure we support dnd.
    ...
    /**
     * Constructor with a default border and the option to recursively set drop targets. If your component is a <tt>java.awt.Container</tt>, then each
     * of its children components will also listen for drops, though only the parent will change borders.
     *
     * @param c
    ...
    /**
     * Constructor with a specified border and the option to recursively set drop targets. If your component is a <tt>java.awt.Container</tt>, then
     * each of its children components will also listen for drops, though only the parent will change borders.
     *
     * @param c
     *            Component on which files will be dropped.
     * @param dragBorder
    ...
    /**
     * Constructs a {@link FileDrop} with a default light-blue border and, if <var>c</var> is a {@link java.awt.Container}, recursively sets all
     * elements contained within as drop targets, though only the top level container will change borders.
     *
     * @param c
     *            Component on which files will be dropped.
     * @param listener
    ...
    /**
     * Constructor with a default border, debugging optionally turned on and the option to recursively set drop targets. If your component is a
     * <tt>java.awt.Container</tt>, then each of its children components will also listen for drops, though only the parent will change borders. With
     * Debugging turned on, more status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt>
     * or <tt>System.err</tt>. A <tt>null</tt> value for the parameter <tt>out</tt> will result in no debugging output.
     *
     * @param out
    ...
    /**
     * Full constructor with a specified border and debugging optionally turned on. With Debugging turned on, more status messages will be displayed
     * to <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the
                ...
                public void drop(final java.awt.dnd.DropTargetDropEvent evt) {
                    ...
                    try { // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported(java.awt.datatransfer.DataFlavor.javaFileListFlavor)) {
                            ...
                            // Get a useful list
                            final java.util.List<?> fileList = (List<?>) tr
     ...
     * <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the parameter
