...
/**
 * The <code>JFontChooser</code> class is a swing component for font selection. This class has <code>JFileChooser</code> like APIs. The following code
...
public class JFontChooser extends JComponent {
    protected class DialogCancelAction extends AbstractAction {
        ...
        protected DialogCancelAction(final JDialog dialog) {
            ...
            this.putValue(Action.NAME,
                    JFontChooser.this._(DialogCancelAction.ACTION_NAME));
        }
    ...
    protected class DialogOKAction extends AbstractAction {
        ...
        protected DialogOKAction(final JDialog dialog) {
            ...
            this.putValue(Action.NAME,
                    JFontChooser.this._(DialogOKAction.ACTION_NAME));
        }
    ...
    protected String _(final String key) {
        String value = key;
        try {
    ...
    protected JDialog createDialog(final Component parent) {
        ...
        final JDialog dialog = new JDialog(frame, this._("SelectFont"), true);
    ...
    protected JPanel getFontFamilyPanel() {
        if (fontNamePanel == null) {
            ...
            final JLabel label = new JLabel(this._("FontName"));
    ...
    protected JPanel getFontSizePanel() {
        if (fontSizePanel == null) {
            ...
            final JLabel label = new JLabel(this._("FontSize"));
            label.setHorizontalAlignment(SwingConstants.LEFT);
            label.setHorizontalTextPosition(SwingConstants.LEFT);
    ...
    protected String[] getFontStyleNames() {
        if (fontStyleNames == null) {
            ...
            fontStyleNames[i++] = this._("Plain");
            fontStyleNames[i++] = this._("Bold");
            fontStyleNames[i++] = this._("Italic");
            fontStyleNames[i++] = this._("BoldItalic");
        }
    ...
    protected JPanel getFontStylePanel() {
        if (fontStylePanel == null) {
            ...
            final JLabel label = new JLabel(this._("FontStyle"));
            label.setHorizontalAlignment(SwingConstants.LEFT);
            label.setHorizontalTextPosition(SwingConstants.LEFT);
    ...
    protected JPanel getSamplePanel() {
        if (samplePanel == null) {
            final Border titledBorder = BorderFactory.createTitledBorder(
                    BorderFactory.createEtchedBorder(), this._("Sample"));
    ...
    protected JTextField getSampleTextField() {
        if (sampleText == null) {
            ...
            sampleText = new JTextField(this._("SampleString"));
